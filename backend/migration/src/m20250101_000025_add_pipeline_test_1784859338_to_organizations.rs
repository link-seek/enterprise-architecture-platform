...
/// Adds a nullable `pipeline_test_1784859338` column to the `organizations` table.
///
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(
            r#"ALTER TABLE "organizations" ADD COLUMN "pipeline_test_1784859338" TEXT"#,
        )
        .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(
            r#"ALTER TABLE "organizations" DROP COLUMN "pipeline_test_1784859338""#,
        )
        .await?;
        Ok(())
    }
