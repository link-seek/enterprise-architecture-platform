...
/// Adds a nullable `pipeline_test_1787544556` column to the `organizations` table.
///
...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(
            r#"ALTER TABLE "organizations" ADD COLUMN "pipeline_test_1787544556" TEXT"#,
        )
        .await?;
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        db.execute_unprepared(
            r#"ALTER TABLE "organizations" DROP COLUMN "pipeline_test_1787544556""#,
        )
        .await?;
        Ok(())
    }
