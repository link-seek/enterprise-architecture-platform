    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2"><Label htmlFor="cap-name">名称</Label><Input id="cap-name" value={name} onChange={e => setName(e.target.value)} /></div>
          <div className="space-y-2"><Label htmlFor="cap-desc">描述</Label><Input id="cap-desc" value={description} onChange={e => setDescription(e.target.value)} /></div>
